...
<?php $__env->startSection('content'); ?>
    <div id="frame">
        <div id="sidepanel">
            ...
            <div id="bottom-bar">
                <button id="addcontact" onclick="location.href='<?php echo e(url('home')); ?>'"><i class="fa fa-user-plus fa-fw" aria-hidden="true"></i> <span>Add contact</span></button>
        ...
        <div class="content">
            <div class="contact-profile">
                ...
                <p> <?php echo e(($conversation->user1()->first()->id==Auth::user()->id)?$conversation->user2()->first()->name:$conversation->user1()->first()->name); ?>
                ...
                <?php $__currentLoopData = $conversation->messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="row">
                        <div class="message <?php echo e(($message->user_id!=Auth::user()->id)?'not_owner':'owner'); ?>">
                            ...
                            <span class="time_date"><?php echo e(now()->toDayDateTimeString()); ?></span>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
